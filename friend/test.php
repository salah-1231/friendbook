            ...
            <div class="row align-items-start">
                <div class="col ">
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            $user2 = $row['uName'];
                            echo $user2;
                            echo  "<a href='friendreq.php?u2=$user2'>  add </a> <br>";
                        }
                    } else {
                        echo "no users";
                    } ?>
                ...
                <div class="col ">
                    ...
                    while ($row = mysqli_fetch_array($result2)) {
                        $postid = $row['pId'];
                        echo "<div class='list-inline center postcss'>";
                        ...
                        if (mysqli_num_rows($likeresult) == 1) {  ?>
                            <div id="plikes">
                                <span class="unlike btn btn-secondary" data-id="<?php echo $postid; ?>">unlike</span>
                                <span class="collapse like btn btn-secondary" data-id="<?php echo $postid; ?>">like</span>
                                <p class="likes_count"><?php echo $numoflikes . "  "; ?>likes</p>
                            <?php  } else { ?>
                                <span class="like btn btn-secondary" data-id="<?php echo $postid; ?>">like</span>
                                <span class="collapse unlike btn btn-secondary" data-id="<?php echo $postid; ?>">unlike</span>
                                ...
                                $('span.like').on('click', function() {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(data) {
                                            ...
                                            $post.parent().find('p .likes_count').text(response + " likes");
                                        }
                                    });
                                });
